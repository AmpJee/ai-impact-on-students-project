...
def raw_df():
    ...
    return pd.DataFrame({
        ...
        "Major_Category": np.tile(["STEM", "Business", "Arts", "Humanities", "Medical"], n // 5),
        "Year_of_Study": np.tile(["Freshman", "Sophomore", "Junior", "Senior", "Graduate"], n // 5),
        ...
        "Primary_Use_Case": np.tile(
            ["Copywriting/Drafting", "Ideation", "Summarizing_Reading",
             "Debugging/Troubleshooting", "Direct_Answer_Generation"], n // 5),
        "Prompt_Engineering_Skill": np.tile(["Beginner", "Intermediate", "Advanced"], n // 3),
